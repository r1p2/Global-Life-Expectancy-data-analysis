...
# 4. A scatterplot to visualize the changing trends in life expectancy throughout the years

# In[40]:


led_df_year = led_df[led_df['Year'].isin([2011,2012,2013,2014,2015])]
plt.xticks(led_df_year['Year'])
sns.scatterplot(data=led_df_year, x="Year", y="Life_Expectancy",hue="Life_Expectancy",s=50)
...
corr_led_df = pd.DataFrame(led_df,columns=led_df_column)
corrMatrix = corr_led_df.corr()
